...
def animate_frame_bird(framec=1):
    canvas.itemconfigure(window_id_k,image= window_pictures_k[framec],anchor='nw')
    canvas.after(50 , animate_frame_bird, (framec + 1) % len(window_pictures_k))
...
window_pictures_k = [PhotoImage(file=f'ресурсы/e_{z}s_2_k.png')for z in range(1,8)]
window_id_k = canvas.create_image(10,10, image = window_pictures_k[0],anchor = 'nw')
